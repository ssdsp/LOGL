...
glm::mat4 customLookAt(glm::vec3 position, glm::vec3 target, glm::vec3 up)
{
...
public:
	...
	{
		return customLookAt(glm::vec3(0.0f, 0.0f, 3.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	}
	...
	void ProcessKeyboard(Camera_Movement direction, float deltaTime)
	{
		...
		if (direction == FORWARD)
			Position += Front * velocity; // Edited so that the user will not move in the y-plane.
